...
-- changeset htoomaungthait:1753204646451-1
...
-- changeset htoomaungthait:1753204646451-2
...
-- changeset htoomaungthait:1753204646451-3
CREATE INDEX article_fk_idx ON comments(article_id);

-- changeset htoomaungthait:1753204646451-4
